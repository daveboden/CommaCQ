...
public class JmsCqClient<BeanType> {
	...
	private final UpdatableLayer csvUpdatableDataSource;
	
	SimpleMessageListenerContainer broadcastUpdateListener;
	
	public JmsCqClient(final String entityId, final UpdatableLayer csvUpdatableDataSource, ConnectionFactory connectionFactory, String fetchAllQueue, int timeoutInSeconds) throws JMSException {
